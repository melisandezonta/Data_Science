...
source('~/Documents/GTL_courses/Data_Visual_Analytics/Assignments/ac5/ac5.R')  # load functions to be tested
options(run.main=TRUE)  # revert back to running "main" block

# Define common variables and utility functions
data_dir <- "/Users/jacquelineroudes/Documents/GTL_courses/Data_Visual_Analytics/Assignments/ac5/data"
label_dir <- "/Users/jacquelineroudes/Documents/GTL_courses/Data_Visual_Analytics/Assignments/ac5/labeled_windows"
